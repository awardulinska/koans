...
public class AboutCollections {
    ...
    public void usingAnArrayList() {
        ...
        list.add("Dog");
        list.add("Chicken");
        assertEquals(list.get(0),"Chicken"); // metoda prownuje czy to co wpisałam
    ...
    public void usingABasicMap() {
        ...
        assertEquals(map.containsValue("first value"),false); // wartość została nadpisana, first value już nie ma
                                                                    // bo została zastąpiona przez other value
    ...
    public void usingBackedSubMap() {
        ...
        assertEquals(map.size(), 6);        // obie mapy zwiększyły swój size, to co wrzucam do BackedMap
